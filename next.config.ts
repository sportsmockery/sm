...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/author/casino-slot-play/:path*', destination: '/', permanent: true },
      ...
      { source: '/author/soccer-event/:path*', destination: '/', permanent: true },
      ...
      { source: '/author/hhc-infused/:path*', destination: '/', permanent: true },
      ...
      { source: '/author/gems-and-mines/:path*', destination: '/', permanent: true },
