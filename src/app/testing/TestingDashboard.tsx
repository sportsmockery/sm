...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'video-film-room', label: 'Untold Chicago Stories page loads (was Bears Film Room)', route: '/bears-film-room' },
      { id: 'video-pi', label: 'Pinwheels & Ivy page loads', route: '/pinwheels-and-ivy' },
      { id: 'video-untold', label: 'Old /untold-chicago-stories URL redirects to /bears-film-room', route: '/untold-chicago-stories' },
