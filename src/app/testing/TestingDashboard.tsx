...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'bulls-record', label: 'Season record is correct: 23-22 (2025-26 season)', route: '/chicago-bulls' },
      { id: 'bulls-roster', label: 'Roster page shows about 15 current players', route: '/chicago-bulls/roster', priority: 'critical' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'cubs-cap', label: 'Cap tracker shows salary info with a $241M luxury tax threshold', route: '/chicago-cubs/cap-tracker' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'hawks-record', label: 'Season record is correct: 21-22-8 (2025-26 season)', route: '/chicago-blackhawks' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'sox-cap', label: 'Cap tracker shows salary info with a $241M luxury tax threshold', route: '/chicago-white-sox/cap-tracker' },
