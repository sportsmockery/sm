...
interface GradeResult { grade: number; reasoning: string; status: string; is_dangerous: boolean; trade_summary?: string; improvement_score?: number; shared_code?: string; breakdown?: { talent_balance: number; contract_value: number; team_fit: number; future_assets: number }; cap_analysis?: string; draft_analysis?: string; service_time_analysis?: string; arb_projection?: string; control_timeline?: string; cbt_impact?: string; rejection_reason?: string; draftPickValuesSent?: DraftPickValue[]; draftPickValuesReceived?: DraftPickValue[]; veteranValueSent?: VeteranTradeValue[]; veteranValueReceived?: VeteranTradeValue[]; futurePicksSent?: FuturePickValue[]; futurePicksReceived?: FuturePickValue[]; agingCurvesSent?: AgingCurveData[]; agingCurvesReceived?: AgingCurveData[]; historical_comparisons?: HistoricalTradeRef[]; suggested_trade?: SuggestedTrade | null; historical_context?: HistoricalContext | null; enhanced_suggested_trade?: EnhancedSuggestedTrade | null }
