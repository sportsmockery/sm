...
export default function ARHelmetPage2() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      // 3) Load helmet model V2 - NO wireframe, keep original materials
      ...
      loader.load(
          ...
          helmet.traverse((node) => {
            if ((node as THREE.Mesh).isMesh) {
              ...
              if (mesh.material) {
                ...
                console.log('Helmet V2 material:', mat.type);
              }
            }
          });
        ...
        (progress) => {
          console.log('Loading helmet V2:', (progress.loaded / progress.total * 100).toFixed(0) + '%');
        },
        (err) => console.error('Helmet V2 load error:', err)
      );
