...
export const metadata: Metadata = {
  title: 'Chicago White Sox Game Center | Sports Mockery',
  description:
    'Live scores, play-by-play, previews.',
  openGraph: {
    title: 'Chicago White Sox Game Center',
...
export default async function WhiteSoxGameCenterPage() {
    ...
    <TeamHubLayout team={team} record={record} nextGame={nextGame} activeTab="game-center">
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          >
            White Sox Game Center
          </h1>
          <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
            Live scores, play-by-play, and game previews for every White Sox game.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '32px' }}>
          {[
            { label: 'Full Schedule', href: '/chicago-white-sox/schedule' },
            { label: 'Box Scores', href: '/chicago-white-sox/scores' },
            { label: 'Team Stats', href: '/chicago-white-sox/stats' },
        ...
        {/* Hub Updates Feed */}
        <HubUpdatesFeed hubSlug="game-center" teamSlug="chicago-white-sox" title="Game Notes" emptyState="No game notes yet." />
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '12px' }}>
            ...
            >
              Ask Scout About White Sox Games
            </h3>
          </div>
...
function GameRow({ game }: { game: WhiteSoxGame }) {
  ...
  return (
    <Link
      href={isCompleted ? '/chicago-white-sox/scores' : '/chicago-white-sox/schedule'}
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {game.stadium && (
            <div style={{ fontSize: '11px', color: 'var(--sm-text-dim)' }}>{game.stadium}</div>
          )}
        </div>
