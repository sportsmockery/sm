...
export const metadata: Metadata = {
  title: 'Chicago White Sox Trade Rumors (Live) | Sports Mockery',
  description:
    'Live White Sox trade tracker, rumor mill, payroll analysis. Chris Getz rumors hourly.',
  openGraph: {
    title: 'Chicago White Sox Trade Rumors (Live)',
    description:
      'Live White Sox trade tracker, rumor mill, payroll analysis. Chris Getz rumors hourly.',
    type: 'website',
  },
...
export default async function WhiteSoxTradeRumorsPage() {
  ...
  // Filter for rumor/trade posts, fallback to all posts
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
            Live Chicago White Sox trade tracker, rumor mill, payroll analysis. Rebuild moves updated hourly.
          </p>
        </div>
        ...
        {/* Rumor Ticker */}
        <RumorTicker teamSlug="chicago-white-sox" />

        {/* Hub Updates Feed */}
        <HubUpdatesFeed hubSlug="trade-rumors" teamSlug="chicago-white-sox" title="Live Updates" emptyState="No trade updates yet. Check back soon." />
          ...
          {transformedPosts.length === 0 && (
            ...
            >
              <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px' }}>
                No trade rumors right now. Check back soon for the latest White Sox trade news.
              </p>
            </div>
          )}
        </section>
        ...
        >
          ...
          <p style={{ color: 'var(--sm-text-muted)', fontSize: '14px', margin: '0 0 16px 0' }}>
            Get instant AI-powered answers about White Sox trades, rebuild targets, and payroll implications.
          </p>
          <Link
            href="/scout-ai?team=chicago-white-sox&q=What%20are%20the%20latest%20White%20Sox%20trade%20rumors"
