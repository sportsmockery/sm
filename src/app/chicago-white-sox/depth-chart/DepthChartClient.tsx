...
export default function DepthChartClient({
  ...
  const filteredGroups = positionGroups.filter((g) => {
    ...
    if (sideFilter === 'pitchers') return g.key === 'pitchers'
    if (sideFilter === 'position') return ['catchers', 'infielders', 'outfielders'].includes(g.key)
    return true
  })
    ...
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
          Full roster with position depth. Click any player for their full profile and stats.
        </p>
      </div>
      ...
      >
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', fontSize: '14px' }}>
            ...
            <span>
              <span style={{ color: 'var(--sm-text-muted)' }}>P: </span>
              <span style={{ fontWeight: 600, color: 'var(--sm-text)' }}>{pitcherCount}</span>
            </span>
            <span>
              <span style={{ color: 'var(--sm-text-muted)' }}>POS: </span>
            ...
            {(['all', 'pitchers', 'position'] as SideFilter[]).map((f) => (
              <button
                ...
                style={{
                  ...
                  backgroundColor: sideFilter === f ? '#27251F' : 'transparent',
                  color: sideFilter === f ? '#C4CED4' : 'var(--sm-text-muted)',
                  borderColor: sideFilter === f ? '#27251F' : 'var(--sm-border)',
                }}
              >
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          fontSize: '12px',
                          fontWeight: 700,
                          color: isStarter ? '#27251F' : 'var(--sm-text-dim)',
                          textAlign: 'center',
                          flexShrink: 0,
                        }}
                      >
                      ...
                      <div
                        style={{
                          ...
                          fontWeight: 700,
                          flexShrink: 0,
                          backgroundColor: isStarter ? '#27251F' : 'var(--sm-surface)',
                          color: isStarter ? '#C4CED4' : 'var(--sm-text-muted)',
                        }}
                      >
                        {player.jerseyNumber ?? '--'}
                      </div>
                      ...
                      <div
                        style={{
                          ...
                          overflow: 'hidden',
                          flexShrink: 0,
                          border: isStarter ? '2px solid #27251F' : '2px solid var(--sm-border)',
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: '12px', color: 'var(--sm-text-muted)' }}>
                          {player.position}
                          {player.bats && player.throws && <span> &middot; B/T: {player.bats}/{player.throws}</span>}
                      ...
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        style={{
                          color: isHovered ? '#27251F' : 'var(--sm-text-dim)',
                          flexShrink: 0,
