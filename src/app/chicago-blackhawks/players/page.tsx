...
function PlayerCard({ player }: { player: BlackhawksPlayer }) {
  return (
    <Link
      ...
      className="group bg-[var(--bg-elevated)] border border-[var(--border-subtle)] rounded-xl overflow-hidden hover:border-[#CF0A2C]/50 transition-colors"
    >
      {/* Player Photo */}
      ...
      {/* Player Info */}
      <div className="p-3">
        <h3 className="font-semibold text-[var(--text-primary)] text-sm truncate group-hover:text-[#CF0A2C] transition-colors">
          {player.fullName}
        </h3>
