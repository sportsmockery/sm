...
function SocialLinks() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', marginTop: '16px' }}>
      <a href="https://www.youtube.com/@PinwheelsandIvyPodcast?sub_confirmation=1" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', opacity: 0.8 }} title="Subscribe on YouTube">
      ...
      <a href="https://podcasts.apple.com/us/podcast/pinwheels-and-ivy-podcast/id1385696768" target="_blank" rel="noopener noreferrer" style={{ opacity: 0.8 }} title="Listen on Apple Podcasts">
        <img src="/icons/apple-podcast.png" alt="Apple Podcasts" style={{ width: 32, height: 32, objectFit: 'contain' }} />
      </a>
      <a href="https://open.spotify.com/show/0OwGxGhYsTY30y60Ui9juT" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', opacity: 0.8 }} title="Listen on Spotify">
      ...
      <a href="https://x.com/PinwheelsIvyPod" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', opacity: 0.8 }} title="Follow on X">
        ...
        <section className="sm-show-hero">
          <div className="sm-container sm-hero-inner">
            <div className="sm-hero-text">
              <img src="/youtubelogos/pi-logo.png" alt="Pinwheels and Ivy" style={{ marginBottom: '0.5rem', maxWidth: '320px', height: 'auto', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
              <span className="sm-tag" style={{ display: 'inline-flex', margin: '0 auto 8px' }}>Pinwheels &amp; Ivy</span>
    ...
    <main className="sm-show-page sm-pinwheels-ivy">
      ...
      <section className="sm-show-cta">
        <div className="sm-container sm-cta-inner">
          <p className="sm-cta-text">Want more Pinwheels &amp; Ivy episodes?</p>
          <a href="https://www.youtube.com/@PinwheelsandIvyPodcast/streams" target="_blank" rel="noopener noreferrer" className="btn-primary">
