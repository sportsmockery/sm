...
type SideFilter = 'all' | 'guards' | 'forwards' | 'centers'
    ...
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
          Interactive roster with starter/backup hierarchy. Click any player for their full profile.
        </p>
      </div>
      ...
      >
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', fontSize: '14px' }}>
            ...
            <span>
              <span style={{ color: 'var(--sm-text-muted)' }}>Guards: </span>
              <span style={{ fontWeight: 600, color: 'var(--sm-text)' }}>{guardsCount}</span>
            </span>
            <span>
              <span style={{ color: 'var(--sm-text-muted)' }}>Forwards: </span>
              <span style={{ fontWeight: 600, color: 'var(--sm-text)' }}>{forwardsCount}</span>
            </span>
            <span>
              <span style={{ color: 'var(--sm-text-muted)' }}>Centers: </span>
              <span style={{ fontWeight: 600, color: 'var(--sm-text)' }}>{centersCount}</span>
            </span>
          </div>
          <div style={{ display: 'flex', gap: '6px' }}>
            {(['all', 'guards', 'forwards', 'centers'] as SideFilter[]).map((f) => (
              <button
                key={f}
                ...
                style={{
                  ...
                  backgroundColor: sideFilter === f ? '#CE1141' : 'transparent',
                  color: sideFilter === f ? '#ffffff' : 'var(--sm-text-muted)',
                  borderColor: sideFilter === f ? '#CE1141' : 'var(--sm-border)',
                }}
              >
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          fontSize: '12px',
                          fontWeight: 700,
                          color: isStarter ? '#CE1141' : 'var(--sm-text-dim)',
                          textAlign: 'center',
                          flexShrink: 0,
                        }}
                      >
                      ...
                      <div
                        style={{
                          ...
                          fontWeight: 700,
                          flexShrink: 0,
                          backgroundColor: isStarter ? '#CE1141' : 'var(--sm-surface)',
                      ...
                      <div
                        style={{
                          ...
                          overflow: 'hidden',
                          flexShrink: 0,
                          border: isStarter ? '2px solid #CE1141' : '2px solid var(--sm-border)',
                      ...
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        style={{
                          color: isHovered ? '#CE1141' : 'var(--sm-text-dim)',
                          flexShrink: 0,
