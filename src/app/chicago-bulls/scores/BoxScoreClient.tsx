              ...
              <button key={game.gameId} onClick={() => setSelectedGameId(game.gameId)}
                ...
                <div className="text-left">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-sm font-semibold" style={{ color: isSelected ? '#FAFAFB' : 'var(--sm-text)' }}>{game.bullsScore}-{game.oppScore}</span>
                  </div>
                </div>
              </button>
            )
          ...
          <div className="flex rounded-xl overflow-hidden" style={{ border: '1px solid var(--sm-border)' }}>
            <button onClick={() => setActiveTeam('bulls')}
              ...
              style={{
                ...
                color: activeTeam === 'bulls' ? '#FAFAFB' : 'var(--sm-text-muted)',
              }}>
