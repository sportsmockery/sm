...
export const metadata: Metadata = {
  ...
  description:
    'Bulls 2026 NBA Draft prospects, mock drafts, trade scenarios. Build your draft.',
  keywords: 'Chicago Bulls mock draft, Bulls draft prospects 2026, NBA Draft Bulls picks, Bulls draft news',
  openGraph: {
    title: 'Chicago Bulls Draft Tracker & Mock Drafts 2026',
    description:
      'Build your Bulls mock draft. Latest 2026 NBA Draft news, prospect rankings, trade scenarios.',
    type: 'website',
  },
  twitter: {
    title: 'Bulls 2026 NBA Mock Draft Simulator',
    description:
      'Create your Chicago Bulls mock draft. Latest NBA Draft news and prospect rankings.',
  },
}
...
export default async function BullsDraftTrackerPage() {
  ...
  const draftKeywords = ['draft', 'prospect', 'mock', 'pick', 'combine', 'scouting', 'lottery']
  ...
  const serializedPosts = displayPosts.map((p: any) => ({
    ...
    author: p.author ? { displayName: p.author.displayName || p.author.display_name } : null,
  }))
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
            Bulls 2026 NBA Draft prospects, mock drafts, trade scenarios. Build your own mock draft.
          </p>
        </div>
