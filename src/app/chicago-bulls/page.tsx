...
export const metadata: Metadata = {
  title: 'Chicago Bulls News, Stats & Roster',
  description: 'Complete Chicago Bulls coverage — breaking news, trade rumors, in-depth analysis, team stats, schedule, roster, and player profiles from Sports Mockery.',
  alternates: { canonical: '/chicago-bulls' },
  openGraph: {
    title: 'Chicago Bulls News & Analysis | Sports Mockery',
    description: 'Your #1 source for Chicago Bulls news, stats, schedule, roster, and expert analysis.',
    type: 'website',
