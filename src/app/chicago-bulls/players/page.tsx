...
function PlayerCard({ player }: { player: BullsPlayer }) {
  return (
    <Link
      ...
      className="group overflow-hidden hover:border-[#CE1141]/50 transition-colors"
    ...
    >
      ...
      {/* Player Info */}
      <div className="p-3">
        <h3 className="font-semibold text-[var(--sm-text)] text-sm truncate group-hover:text-[#CE1141] transition-colors">
          {player.fullName}
        </h3>
