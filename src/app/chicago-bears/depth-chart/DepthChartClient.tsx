...
export default function DepthChartClient({
  ...
  const filteredGroups = positionGroups.filter((g) => {
    ...
    if (sideFilter === 'offense') return g.key === 'Offense'
    if (sideFilter === 'defense') return g.key === 'Defense'
    if (sideFilter === 'special') return g.key === 'Special Teams'
    return true
  })
    ...
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
          Interactive depth chart with real depth ordering and injury status. Click any player for their full profile.
        </p>
      </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <svg
                            ...
                            viewBox="0 0 24 24"
                            style={{
                              color: isHovered ? teamColor : 'var(--sm-text-dim)',
                              flexShrink: 0,
