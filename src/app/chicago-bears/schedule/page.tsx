...
export const metadata: Metadata = {
  title: '2025 Chicago Bears Schedule & Results',
  description: 'Full 2025 Chicago Bears schedule with game dates, times, opponents, TV channels, scores, and results. Track upcoming matchups and past game outcomes.',
  alternates: { canonical: '/chicago-bears/schedule' },
  openGraph: {
    title: '2025 Chicago Bears Schedule | Sports Mockery',
    description: 'Complete Bears schedule with dates, times, opponents, and results for the 2025 season.',
      ...
      <div className="pb-12">
          ...
          <div className="flex flex-wrap gap-6 justify-center text-center">
            ...
            {(separatedRecord.postseason.wins > 0 || separatedRecord.postseason.losses > 0) && (
              <div>
                ...
                <div style={{ fontSize: '22px', fontWeight: 800, color: 'var(--sm-red)' }}>
          ...
          <div className="glass-card glass-card-static" style={{ overflow: 'hidden', padding: 0, marginTop: 24 }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <h2 style={{ fontWeight: 700, color: 'var(--sm-red)', margin: 0 }}>
                  Postseason
                </h2>
                <span style={{
                  padding: '3px 10px',
        ...
        {preseasonGames.length > 0 && (
          <div className="glass-card glass-card-static" style={{ overflow: 'hidden', padding: 0, marginTop: 24 }}>
            ...
            >
              <h2 style={{ fontWeight: 700, color: 'var(--sm-text-muted)', fontSize: 16 }}>
                Preseason
              </h2>
            </div>
            <div>
