...
import { getBearsPlayers } from '@/lib/bearsData'

export const revalidate = 3600

/**
 * /chicago-bears/players redirects to the first player by jersey number
...
export default async function PlayersIndexPage() {
  ...
  redirect(`/chicago-bears/players/${firstPlayer.slug}`)
}
