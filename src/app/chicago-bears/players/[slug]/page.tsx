        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-8">
            ...
            {currentSeason && (
              <section className="glass-card glass-card-static">
                <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6" style={{ color: 'var(--sm-text)' }}>
            ...
            {postseasonStats && postseasonStats.gamesPlayed > 0 && (
              <section className="glass-card glass-card-static" style={{ borderLeft: '3px solid var(--sm-red)' }}>
                <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6" style={{ color: 'var(--sm-red)' }}>
            ...
            {gameLog.length > 0 && (
              <section className="glass-card glass-card-static" style={{ overflow: 'hidden', padding: 0 }}>
                <div className="p-4 sm:p-6" style={{ borderBottom: '1px solid var(--sm-border)' }}>
                  <h2 className="text-lg sm:text-xl font-bold" style={{ color: 'var(--sm-text)' }}>
                    Game Log 2025
                  </h2>
                </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            {similarPlayers.length > 0 && (
              <section className="glass-card glass-card-static">
                <h3 className="text-base sm:text-lg font-bold mb-3 sm:mb-4" style={{ color: 'var(--sm-text)' }}>
                  Similar Bears
                </h3>
