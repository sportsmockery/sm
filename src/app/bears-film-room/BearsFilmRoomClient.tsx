...
function SocialLinks() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', marginTop: '16px' }}>
      <a href="https://www.youtube.com/@bearsfilmroom?sub_confirmation=1" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', opacity: 0.8, transition: 'opacity 0.2s' }} title="Subscribe on YouTube">
      ...
      <a href="https://podcasts.apple.com/us/podcast/bears-film-room-a-chicago-bears-show/id1690627823" target="_blank" rel="noopener noreferrer" style={{ opacity: 0.8, transition: 'opacity 0.2s' }} title="Listen on Apple Podcasts">
        <img src="/icons/apple-podcast.png" alt="Apple Podcasts" style={{ width: 32, height: 32, objectFit: 'contain' }} />
      </a>
      <a href="https://open.spotify.com/show/4PrKJqFN7qJJIwM8qH2OWT" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', opacity: 0.8, transition: 'opacity 0.2s' }} title="Listen on Spotify">
      ...
      <a href="https://x.com/bfr_pod" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', opacity: 0.8, transition: 'opacity 0.2s' }} title="Follow on X">
        ...
        <section className="sm-show-hero">
          <div className="sm-container sm-hero-inner">
            <div className="sm-hero-text">
              <img src="/youtubelogos/bfr-wide.png" alt="Bears Film Room" style={{ marginBottom: '0.5rem', maxWidth: '320px', height: 'auto', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
              <span className="sm-tag" style={{ display: 'inline-flex', margin: '0 auto 8px' }}>Bears Film Room</span>
              <h1 style={{ fontSize: '36px', fontWeight: 700, color: 'var(--sm-text)', fontFamily: "Barlow, var(--font-heading), sans-serif", margin: '0 0 8px', textAlign: 'center' }}>
    ...
    <main className="sm-show-page sm-bears-film-room">
      ...
      <section className="sm-show-previous">
        <div className="sm-container">
          <h2 style={{ fontSize: '22px', fontWeight: 700, color: 'var(--sm-text)', fontFamily: "Barlow, var(--font-heading), sans-serif", margin: '0 0 16px' }}>
            Recent episodes
          </h2>
      ...
      <section className="sm-show-cta">
        <div className="sm-container sm-cta-inner">
          <p className="sm-cta-text">Want more Bears Film Room breakdowns?</p>
          <a href="https://www.youtube.com/@bearsfilmroom/streams" target="_blank" rel="noopener noreferrer" className="btn-primary">
