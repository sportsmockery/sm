              ...
              <div className="flex items-center gap-12 mb-3">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-between w-36 px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white text-xs font-semibold rounded transition-colors"
                  >
                    <span>Subscribe</span>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-between w-36 px-3 py-1.5 bg-white hover:bg-gray-100 text-xs font-semibold rounded transition-colors"
                    style={{ color: '#9333ea' }}
                  >
                    <span>Apple</span>
                    <img src="https://logos-world.net/wp-content/uploads/2021/10/Podcast-Emblem.png" alt="Apple Podcasts" className="w-4 h-4 object-contain" />
                  </a>
                  {/* Spotify */}
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-between w-36 px-3 py-1.5 bg-[#1DB954] hover:bg-[#1ed760] text-white text-xs font-semibold rounded transition-colors"
                  >
                    <span>Spotify</span>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-between w-36 px-3 py-1.5 border border-white bg-transparent hover:bg-white/10 text-white text-xs font-semibold rounded transition-colors"
                  >
                    <span>Follow</span>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
