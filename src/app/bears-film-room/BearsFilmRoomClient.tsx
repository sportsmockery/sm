  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', marginTop: '16px' }}>
      ...
      <a href="https://podcasts.apple.com/us/podcast/bears-film-room-a-chicago-bears-show/id1690627823" target="_blank" rel="noopener noreferrer" style={{ opacity: 0.8, transition: 'opacity 0.2s' }} title="Listen on Apple Podcasts">
        <Image src="/icons/apple-podcast.png" alt="Apple Podcasts" width={32} height={32} style={{ objectFit: 'contain' }} />
      </a>
        ...
        <section className="sm-show-hero">
          <div className="sm-container sm-hero-inner">
            <div className="sm-hero-text">
              <OptimizedImage src="/youtubelogos/bfr-wide.png" alt="Bears Film Room" variant="card" style={{ marginBottom: '0.5rem', maxWidth: '320px', height: 'auto', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
    ...
    <main className="sm-show-page sm-bears-film-room">
      ...
      <section className="sm-show-previous">
        <div className="sm-container">
          <h2 style={{ fontSize: '22px', fontWeight: 700, color: 'var(--sm-text)',  margin: '0 0 16px' }}>
            Recent episodes
          </h2>
