...
function SocialLinks() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', marginTop: '16px' }}>
      <a href="https://www.youtube.com/@untoldchicago?sub_confirmation=1" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', opacity: 0.8, transition: 'opacity 0.2s' }} title="Subscribe on YouTube">
      ...
      <a href="https://open.spotify.com/track/0LV2TlOspytIK9K2IJRilB" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', opacity: 0.8, transition: 'opacity 0.2s' }} title="Listen on Spotify">
