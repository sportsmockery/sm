          ...
          <div className="sm-container sm-hero-inner">
            <div className="sm-hero-text">
              ...
              <div className="flex items-center justify-center gap-5 mt-4">
                ...
                {/* Apple Podcasts */}
                <a
                  href="https://podcasts.apple.com/us/podcast/pinwheels-and-ivy-podcast/id1385696768"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:opacity-70 transition-opacity"
                  title="Listen on Apple Podcasts"
                >
                  <img src="/icons/apple-podcast.png" alt="Apple Podcasts" className="w-8 h-8 object-contain" />
                </a>
                {/* Spotify */}
                <a
                  href="https://open.spotify.com/show/0OwGxGhYsTY30y60Ui9juT"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-white/70 transition-colors"
                ...
                {/* Twitter/X */}
                <a
                  href="https://x.com/PinwheelsIvyPod"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-white/70 transition-colors"
                  title="Follow on X"
