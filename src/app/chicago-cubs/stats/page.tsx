...
export const metadata: Metadata = {
  title: 'Chicago Cubs Stats 2026 | Team & Player Statistics | SportsMockery',
  description: 'Chicago Cubs 2026 team and player statistics. View batting averages, home runs, RBIs, and pitching stats.',
}
