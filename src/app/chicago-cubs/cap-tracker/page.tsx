...
export const metadata: Metadata = {
  title: 'Chicago Cubs Payroll Tracker 2025 | Sports Mockery',
  description:
    'Live Cubs payroll, contracts, luxury tax analysis.',
  openGraph: {
    title: 'Chicago Cubs Payroll Tracker 2025',
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
            Live payroll, contract breakdowns, and position spending for the 2025 season.
          </p>
        </div>
