      ...
      {activeTab === 'mock-draft' && (
        <div
          ...
          style={{
            ...
            borderColor: 'rgba(14,51,134,0.2)',
          }}
        >
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
            <div>
              ...
              >
                Build Your Cubs Mock Draft
              </h2>
              <p style={{ color: 'var(--sm-text-muted)', fontSize: '14px', margin: 0 }}>
                Use our interactive mock draft tool to build your ideal Cubs draft board. 20 rounds, 600 picks.
              </p>
            </div>
            <Link
              href="/mock-draft"
      ...
      {activeTab === 'prospects' && (
        <section style={{ marginBottom: '32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: '10px' }}>
            {[
              { position: 'SP', priority: 'High', note: 'Starting pitching depth' },
              { position: 'Corner OF', priority: 'High', note: 'Power bat in corner' },
              { position: 'SS', priority: 'Medium', note: 'Middle infield prospect' },
              { position: 'C', priority: 'Medium', note: 'Catching depth' },
              { position: 'RP', priority: 'Low', note: 'Bullpen arm' },
              { position: 'UTIL', priority: 'Low', note: 'Versatile athlete' },
            ].map((need) => (
              <div
                key={need.position}
          ...
          <section>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {displayPosts.map((post) => {
                const href = post.categorySlug ? `/${post.categorySlug}/${post.slug}` : `/chicago-cubs/${post.slug}`
                return (
