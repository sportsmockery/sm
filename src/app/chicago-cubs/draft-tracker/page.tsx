...
export const metadata: Metadata = {
  title: 'Chicago Cubs Draft Tracker & Mock Drafts 2026 | Sports Mockery',
  description:
    'Cubs 2026 draft prospects, mock drafts, trade scenarios. Build your draft.',
  keywords: 'Chicago Cubs mock draft, Cubs draft prospects 2026, MLB Draft Cubs picks, Cubs draft news',
  openGraph: {
    title: 'Chicago Cubs Draft Tracker & Mock Drafts 2026',
    description:
      'Build your Cubs mock draft. Latest 2026 draft news, prospect rankings, trade scenarios.',
    type: 'website',
  },
  twitter: {
    title: 'Cubs 2026 Mock Draft Simulator',
    description:
      'Create your Chicago Cubs mock draft. Latest draft news and prospect rankings.',
  },
}
  ...
  try {
    ...
    return posts.map((post: any) => ({
      ...
      author: post.sm_authors
        ? { displayName: post.sm_authors.display_name }
        : null,
    }))
  } catch {
    return []
...
export default async function CubsDraftTrackerPage() {
  ...
  const draftKeywords = ['draft', 'prospect', 'mock', 'pick', 'combine', 'scouting', 'amateur']
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
            Cubs 2026 draft prospects, mock drafts, trade scenarios. Build your own mock draft.
          </p>
        </div>
        ...
        <DraftNewsList posts={serializedPosts} teamSlug="chicago-cubs" />
        ...
        >
          ...
          <Link
            href="/scout-ai?team=chicago-cubs&q=What%20should%20the%20Cubs%20do%20in%20the%202026%20draft"
