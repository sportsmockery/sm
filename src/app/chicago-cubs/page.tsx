      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '32px', maxWidth: '1320px', margin: '0 auto' }}>
        ...
        <div className="hub-grid-cubs" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <section>
              <style>{`
                .cubs-features-grid { display: flex; flex-direction: column; gap: 10px; }
                .cubs-feature-card {
                ...
                .cubs-feature-card::before {
                  content: ''; position: absolute; top: 0; left: 0; bottom: 0; width: 3px;
                  background: linear-gradient(180deg, #0E3386, #CC3433); opacity: 0.7; transition: opacity 0.4s;
                }
                .cubs-feature-card:hover { transform: translateX(4px); border-color: rgba(14,51,134,0.2); background: var(--sm-card-hover); }
                .cubs-feature-card:hover::before { opacity: 1; }
                .cubs-feature-btn {
...
function CubsFeatureCard({ href, icon, title, description, buttonText }: { href: string; icon: React.ReactNode; title: string; description: string; buttonText: string }) {
  return (
    <Link href={href} style={{ textDecoration: 'none', display: 'block' }}>
      <div className="cubs-feature-card">
        <div style={{ width: '40px', height: '40px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, rgba(14,51,134,0.3), rgba(204,52,51,0.15))', border: '1px solid rgba(14,51,134,0.2)', color: '#0E3386', flexShrink: 0 }}>{icon}</div>
        <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <span className="cubs-feature-btn" style={{ backgroundColor: '#0E3386', color: '#ffffff' }}>
          {buttonText}
