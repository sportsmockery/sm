...
export const metadata: Metadata = {
  title: 'Chicago Cubs News, Stats & Roster',
  description: 'Complete Chicago Cubs coverage — breaking news, trade rumors, in-depth analysis, team stats, schedule, roster, and player profiles from Sports Mockery.',
  alternates: { canonical: '/chicago-cubs' },
  openGraph: {
    title: 'Chicago Cubs Hub | Sports Mockery',
    description: 'Your #1 source for Chicago Cubs news, stats, schedule, roster, and expert analysis.',
    type: 'website',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px', maxWidth: '1320px', margin: '0 auto' }}>
        ...
        <div className="hub-grid-cubs" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
            ...
            <RecentHubUpdates teamSlug="chicago-cubs" />
