...
export const metadata: Metadata = {
  title: 'Chicago Cubs Game Center | Sports Mockery',
  description:
    'Live scores, play-by-play, previews.',
  openGraph: {
    title: 'Chicago Cubs Game Center',
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--sm-text-muted)', fontSize: '16px', margin: 0, lineHeight: 1.6 }}>
            Live scores, box scores, and game previews for every Cubs game.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '32px' }}>
          {[
            { label: 'Full Schedule', href: '/chicago-cubs/schedule' },
            { label: 'Box Scores', href: '/chicago-cubs/scores' },
            { label: 'Team Stats', href: '/chicago-cubs/stats' },
        ...
        {/* Hub Updates Feed */}
        <HubUpdatesFeed teamSlug="chicago-cubs" hubSlug="game-center" title="Game Notes" emptyState="No game notes yet." />
        ...
        >
          ...
          <Link
            href="/scout-ai?team=chicago-cubs&q=How%20did%20the%20Cubs%20do%20in%20their%20last%20game"
...
function GameRow({ game }: { game: CubsGame }) {
  ...
  return (
    <Link
      href={isCompleted ? '/chicago-cubs/scores' : '/chicago-cubs/schedule'}
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: '10px', color: 'var(--sm-text-dim)' }}>
            {game.gameType === 'postseason' ? 'Postseason' : game.dayOfWeek?.slice(0, 3)}
          </div>
        </div>
