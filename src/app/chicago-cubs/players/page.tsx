...
function PlayerCard({ player }: { player: CubsPlayer }) {
  return (
    <Link
      ...
      className="bg-[var(--bg-elevated)] border border-[var(--border-subtle)] rounded-xl p-4 hover:border-[#0E3386] dark:hover:border-[#CC3433] transition-colors group"
    >
      <div className="flex flex-col items-center text-center">
        {player.headshotUrl ? (
          <div className="w-20 h-20 rounded-full overflow-hidden mb-3 border-2 border-[var(--border-subtle)] group-hover:border-[#0E3386] dark:group-hover:border-[#CC3433] transition-colors">
            <Image
        ...
        <div className="font-semibold text-[var(--text-primary)] group-hover:text-[#0E3386] dark:group-hover:text-[#CC3433] transition-colors truncate w-full">
          {player.fullName}
        </div>
