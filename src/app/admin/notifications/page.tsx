            ...
            <div className="space-y-5 p-6">
              ...
              <div>
                <label className="mb-1.5 block text-sm font-medium text-[var(--text-secondary)]">
                  Notification Title <span className="text-[#BC0000]">*</span>
                </label>
                <input
                  type="text"
                  value={title}
              ...
              <div>
                <label className="mb-1.5 block text-sm font-medium text-[var(--text-secondary)]">
                  Message <span className="text-[#BC0000]">*</span>
                </label>
                <textarea
                  value={body}
                ...
                {selectedArticle ? (
                  <div className="flex items-center gap-3 rounded-lg border border-[var(--border-default)] bg-[var(--bg-tertiary)] p-3">
                    ...
                    <button
                      ...
                      className="rounded-lg p-1.5 text-[var(--text-muted)] hover:bg-[var(--bg-hover)] hover:text-[#BC0000]"
                    >
              ...
              {/* Error */}
              {error && (
                <div className="rounded-lg bg-red-500/10 border border-red-500/20 px-4 py-3 text-sm text-[#BC0000]">
                  {error}
                </div>
              )}
              ...
              {/* Success */}
              {sent && (
                <div className="rounded-lg bg-[#00D4FF]/10 border border-emerald-500/20 px-4 py-3 text-sm text-[#00D4FF] flex items-center gap-2">
