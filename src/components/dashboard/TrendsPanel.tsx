    ...
    >
          ...
          >
            ...
            {tab.count > 0 && (
              <span
                ...
                style={{
                  backgroundColor: activeTab === tab.key ? 'rgba(0,212,255,0.15)' : 'rgba(255,255,255,0.06)',
                  color: activeTab === tab.key ? '#00D4FF' : 'rgba(250,250,251,0.3)',
                }}
              >
                {tab.count}
              </span>
      ...
      <div className="p-3 max-h-[300px] overflow-y-auto">
        {activeTab === 'risers' && trends.risers.map((item: TrendItem, i: number) => (
          <div key={i} className="py-2 border-b last:border-0" style={{ borderColor: 'rgba(255,255,255,0.04)' }}>
            ...
            <p className="text-xs" style={{ color: 'rgba(250,250,251,0.5)' }}>{item.summary}</p>
          </div>
        ))}
