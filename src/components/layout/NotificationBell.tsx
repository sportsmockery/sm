      ...
      case 'breaking':
        return (
          <div className="flex h-8 w-8 items-center justify-center rounded-full" style={{ backgroundColor: 'rgba(239, 68, 68, 0.15)' }}>
            <svg className="h-4 w-4" style={{ color: '#BC0000' }} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
      ...
      case 'score':
        return (
          <div className="flex h-8 w-8 items-center justify-center rounded-full" style={{ backgroundColor: 'rgba(16, 185, 129, 0.15)' }}>
            <svg className="h-4 w-4" style={{ color: '#00D4FF' }} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
