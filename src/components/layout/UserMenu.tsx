        ...
        {isLoggedIn ? (
          <>
            ...
            <div className="p-4" style={{ borderBottom: '1px solid var(--sm-border)' }}>
              <p className="font-semibold" style={{ color: 'var(--sm-text)' }}>John Doe</p>
              <p className="text-sm" style={{ color: 'var(--sm-text-muted)' }}>john@example.com</p>
            </div>
          ...
          <div className="p-4">
            <p className="mb-4 text-center text-sm" style={{ color: 'var(--sm-text-muted)' }}>
            ...
            <div className="space-y-2">
              <Link
                href="/login"
                onClick={() => setIsOpen(false)}
                className="flex w-full items-center justify-center rounded-xl px-4 py-2.5 font-semibold text-white transition-colors"
              ...
              <Link
                href="/signup"
                onClick={() => setIsOpen(false)}
                className="flex w-full items-center justify-center rounded-xl px-4 py-2.5 font-semibold transition-colors"
                style={{ border: '1px solid var(--sm-border)', color: 'var(--sm-text)' }}
              >
                Create Account
              </Link>
            </div>
