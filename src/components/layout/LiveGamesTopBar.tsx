          ...
          {liveGames.map((game) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-1.5 my-1 mx-1 transition-colors min-w-fit"
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  {isGameLive(game) ? (
                    <>
                      ...
                      <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wide" style={{ color: '#FAFAFB' }}>
                        LIVE
                      </span>
                    </>
                  ) : isStartingSoon(game) ? (
