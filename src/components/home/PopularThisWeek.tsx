  ...
  return (
    <section className={className}>
      <div className="rounded-2xl p-6" style={{ backgroundColor: 'var(--sm-card)', border: '1px solid var(--sm-border)' }}>
        {/* Header */}
        <h3 className="mb-4 flex items-center gap-2 font-heading text-lg font-bold" style={{ color: 'var(--sm-text)' }}>
          <svg
            className="h-5 w-5"
            style={{ color: '#8B0000' }}
            fill="none"
            ...
            >
              ...
              <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-lg">
                {article.featured_image ? (
                  ...
                  <div className="h-full w-full" style={{ backgroundColor: 'var(--sm-surface)' }} />
                )}
                {/* Rank badge */}
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 flex items-center gap-1 text-xs" style={{ color: 'var(--sm-text-muted)' }}>
