          ...
          <table className="w-full text-sm min-w-[300px]">
            ...
            <tbody>
              ...
              <tr style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                ...
                {periods.map(p => (
                  <td key={p} className="px-2 py-1.5 text-center" style={{ color: 'rgba(255,255,255,0.5)' }}>{linescore[p].away}</td>
                ))}
                <td className="px-3 py-1.5 text-center font-bold" style={{ color: '#FAFAFB' }}>{game.away_team.score}</td>
              </tr>
              {/* Home */}
              <tr style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                <td className="px-3 py-1.5">
                ...
                {periods.map(p => (
                  <td key={p} className="px-2 py-1.5 text-center" style={{ color: 'rgba(255,255,255,0.5)' }}>{linescore[p].home}</td>
                ))}
                <td className="px-3 py-1.5 text-center font-bold" style={{ color: '#FAFAFB' }}>{game.home_team.score}</td>
              </tr>
            </tbody>
          </table>
        </div>
