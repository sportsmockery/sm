...
const teams = [
  { name: 'Bears', slug: 'chicago-bears', color: teamColors['chicago-bears'].primary },
  { name: 'Bulls', slug: 'chicago-bulls', color: teamColors['chicago-bulls'].primary },
  { name: 'Cubs', slug: 'chicago-cubs', color: teamColors['chicago-cubs'].primary },
  { name: 'White Sox', slug: 'chicago-white-sox', color: teamColors['chicago-white-sox'].primary },
