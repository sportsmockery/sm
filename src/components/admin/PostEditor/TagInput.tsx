      ...
      <label className="mb-1.5 flex items-center gap-1.5 text-xs font-medium text-[var(--text-muted)]">
        ...
        <button
          ...
          style={{
            ...
            background: showInfo ? 'rgba(0,212,255,0.1)' : 'transparent',
            color: showInfo ? '#00D4FF' : '#9ca3af',
          }}
          onMouseEnter={(e) => {
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.color = showInfo ? '#00D4FF' : '#9ca3af'
            e.currentTarget.style.backgroundColor = showInfo ? 'rgba(0,212,255,0.1)' : 'transparent'
          }}
          title="Tag guide"
        >
          <Info size={14} />
