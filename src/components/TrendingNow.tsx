    ...
    <section className={`${className}`}>
      ...
      <div className="flex items-center gap-3 mb-6">
        <div className="relative">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#BC0000] to-[#8B0000] flex items-center justify-center">
          ...
          {/* Animated pulse */}
          <div className="absolute inset-0 rounded-xl bg-[#BC0000] animate-ping opacity-25" />
        </div>
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {posts.map((post, index) => (
          ...
          >
            ...
            {/* Trending badge */}
            <div className="absolute top-3 left-3 z-20 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#BC0000] text-white text-xs font-bold">
  ...
  return (
    <div className={`rounded-2xl overflow-hidden ${className}`} style={{ backgroundColor: 'var(--sm-card)', border: '1px solid var(--sm-border)' }}>
      ...
      <div className="flex items-center gap-2 px-4 py-3" style={{ borderBottom: '1px solid var(--sm-border)' }}>
        <div className="relative">
          <svg className="w-4 h-4 text-[#BC0000]" fill="currentColor" viewBox="0 0 24 24">
            <path d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z" />
          </svg>
        </div>
