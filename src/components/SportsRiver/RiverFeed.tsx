...
const InfographicCard = dynamic(() => import('./cards/InfographicCard').then(m => ({ default: m.InfographicCard })), { ssr: false, loading: () => <div style={{ height: 200, borderRadius: 14, background: 'var(--sm-surface)' }} /> });
const ChartCard = dynamic(() => import('./cards/ChartCard').then(m => ({ default: m.ChartCard })), { ssr: false, loading: () => <div style={{ height: 200, borderRadius: 14, background: 'var(--sm-surface)' }} /> });
