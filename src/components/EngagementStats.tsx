...
export function ArticleEngagementSummary({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
      <div className="flex items-center gap-6">
        ...
        <div className="text-center">
          ...
          <div className="text-xs text-zinc-500 uppercase tracking-wider">Min Read</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">
            {maxDepth}%
          </div>
          <div className="text-xs text-zinc-500 uppercase tracking-wider">Read</div>
        </div>
      </div>
