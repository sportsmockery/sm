...
// SEC-2026-004 fix: credentials loaded from environment variables, not hardcoded

const DATALAB_URL = process.env.DATALAB_SUPABASE_URL || process.env.NEXT_PUBLIC_DATALAB_SUPABASE_URL || 'https://siwoqfzzcxmngnseyzpv.supabase.co'
const DATALAB_ANON_KEY = process.env.DATALAB_SUPABASE_ANON_KEY || process.env.NEXT_PUBLIC_DATALAB_SUPABASE_ANON_KEY || ''
