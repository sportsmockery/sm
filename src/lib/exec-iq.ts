...
- Every tip ends with a clear action — what should Chris DO this week?
...
OUTPUT: valid JSON exactly matching this schema. Return ONLY the JSON, no prose before or after, no markdown fences.
  ...
  "insights": [
    {
      ...
      "action": "concrete action Chris should take this week",
