// lib/getUntoldChicagoVideos.ts
import 'server-only';
import { ShowVideo } from './youtubeTypes';

const UNTOLD_HANDLE = '@untoldchicago';
...
export async function getUntoldChicagoVideos(): Promise<{
  ...
  channelsUrl.searchParams.set('forHandle', UNTOLD_HANDLE);
