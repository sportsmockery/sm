...
const TRADES = [
  // ════ BEARS (NFL) — 20 trades ════
  { id: 1, team: 'bears', sport: 'nfl', partner: 'Green Bay Packers', sent: 'DJ Moore (WR)', recv: 'Jordan Love (QB)', expect: 'low', reason: 'Bears already have Caleb Williams, no need for Love' },
  { id: 2, team: 'bears', sport: 'nfl', partner: 'Los Angeles Rams', sent: 'Montez Sweat (DE)', recv: 'Puka Nacua (WR)', expect: 'mid-high', reason: 'Both elite, good position swap' },
  ...
  { id: 4, team: 'bears', sport: 'nfl', partner: 'Minnesota Vikings', sent: 'Jaylon Johnson (CB)', recv: 'Justin Jefferson (WR)', expect: 'low', reason: 'Jefferson far more valuable, unrealistic' },
  ...
  { id: 6, team: 'bears', sport: 'nfl', partner: 'San Francisco 49ers', sent: 'DJ Moore (WR), 2026 1st Round', recv: 'Nick Bosa (DE)', expect: 'mid', reason: 'Elite edge rusher for WR + pick' },
  { id: 7, team: 'bears', sport: 'nfl', partner: 'Miami Dolphins', sent: 'Rome Odunze (WR)', recv: 'Jaylen Waddle (WR)', expect: 'mid', reason: 'Similar WRs, lateral move' },
  ...
  { id: 9, team: 'bears', sport: 'nfl', partner: 'Philadelphia Eagles', sent: 'Kyler Gordon (CB), 2026 2nd Round', recv: 'A.J. Brown (WR)', expect: 'mid', reason: 'Reasonable package for elite WR' },
  ...
  { id: 11, team: 'bears', sport: 'nfl', partner: 'Kansas City Chiefs', sent: 'Montez Sweat (DE), 2026 1st Round', recv: 'Chris Jones (DT)', expect: 'mid', reason: 'Elite for elite + pick' },
  { id: 12, team: 'bears', sport: 'nfl', partner: 'Cincinnati Bengals', sent: 'Darnell Wright (OT)', recv: 'Tee Higgins (WR)', expect: 'mid', reason: 'Solid value both sides' },
  { id: 13, team: 'bears', sport: 'nfl', partner: 'Las Vegas Raiders', sent: '2026 3rd Round', recv: 'Davante Adams (WR)', expect: 'mid-high', reason: 'Aging WR for mid-round pick' },
  ...
  { id: 15, team: 'bears', sport: 'nfl', partner: 'New England Patriots', sent: 'Khalil Herbert (RB)', recv: 'Drake Maye (QB)', expect: 'low', reason: 'RB has minimal trade value, Maye is a QB' },
  ...
  { id: 17, team: 'bears', sport: 'nfl', partner: 'Pittsburgh Steelers', sent: 'Montez Sweat (DE)', recv: 'T.J. Watt (DE)', expect: 'mid', reason: 'Elite edge for elite edge, age considerations' },
  { id: 18, team: 'bears', sport: 'nfl', partner: 'Tennessee Titans', sent: 'Jaylon Johnson (CB), 2027 2nd Round', recv: 'Jeffery Simmons (DT)', expect: 'mid-high', reason: 'Good package for interior DL' },
  ...
  { id: 20, team: 'bears', sport: 'nfl', partner: 'Houston Texans', sent: 'DJ Moore (WR), 2026 1st Round, 2027 3rd Round', recv: 'Will Anderson Jr. (DE)', expect: 'mid-high', reason: 'Big package for elite young edge' },
  ...
  { id: 22, team: 'bulls', sport: 'nba', partner: 'Golden State Warriors', sent: 'DeMar DeRozan (SF)', recv: 'Stephen Curry (PG)', expect: 'low', reason: 'Warriors not trading Curry' },
  { id: 23, team: 'bulls', sport: 'nba', partner: 'Boston Celtics', sent: 'Zach LaVine (SG)', recv: 'Jaylen Brown (SG)', expect: 'low-mid', reason: 'Brown more valuable, bad salary swap' },
  { id: 24, team: 'bulls', sport: 'nba', partner: 'Phoenix Suns', sent: 'Nikola Vucevic (C)', recv: 'Devin Booker (SG)', expect: 'low', reason: 'Booker far more valuable' },
  ...
  { id: 31, team: 'bulls', sport: 'nba', partner: 'Indiana Pacers', sent: 'Coby White (PG)', recv: 'Tyrese Haliburton (PG)', expect: 'low', reason: 'Haliburton much more valuable' },
  { id: 32, team: 'bulls', sport: 'nba', partner: 'Toronto Raptors', sent: 'Nikola Vucevic (C)', recv: 'Scottie Barnes (PF)', expect: 'low', reason: 'Barnes far more valuable as young star' },
  ...
  { id: 34, team: 'bulls', sport: 'nba', partner: 'Memphis Grizzlies', sent: 'Patrick Williams (PF), 2026 1st Round', recv: 'Jaren Jackson Jr. (PF)', expect: 'mid', reason: 'Fair package for JJJ' },
  { id: 35, team: 'bulls', sport: 'nba', partner: 'Detroit Pistons', sent: 'Nikola Vucevic (C)', recv: 'Cade Cunningham (PG)', expect: 'low', reason: 'Cade worth much more' },
  ...
  { id: 38, team: 'bulls', sport: 'nba', partner: 'Charlotte Hornets', sent: 'Nikola Vucevic (C), 2027 2nd Round', recv: 'Brandon Miller (SF)', expect: 'low', reason: 'Miller on rookie deal, much more valuable' },
  { id: 39, team: 'bulls', sport: 'nba', partner: 'Miami Heat', sent: 'Zach LaVine (SG)', recv: 'Jimmy Butler (SF)', expect: 'mid', reason: 'Star swap, both on big contracts' },
  { id: 40, team: 'bulls', sport: 'nba', partner: 'Minnesota Timberwolves', sent: 'Patrick Williams (PF), Coby White (PG)', recv: 'Karl-Anthony Towns (C)', expect: 'low-mid', reason: 'Package for star, undervalued offer' },
  ...
  { id: 43, team: 'blackhawks', sport: 'nhl', partner: 'Colorado Avalanche', sent: 'Seth Jones (D)', recv: 'Cale Makar (D)', expect: 'low', reason: 'Makar vastly more valuable, Jones overpaid' },
  { id: 44, team: 'blackhawks', sport: 'nhl', partner: 'New York Rangers', sent: 'Alex Vlasic (D), 2026 1st Round', recv: 'Artemi Panarin (LW)', expect: 'mid', reason: 'Fair for aging vet, selling future' },
  { id: 45, team: 'blackhawks', sport: 'nhl', partner: 'Tampa Bay Lightning', sent: 'Seth Jones (D)', recv: 'Nikita Kucherov (RW)', expect: 'low-mid', reason: 'Jones cap dump, Kucherov older' },
  { id: 46, team: 'blackhawks', sport: 'nhl', partner: 'Nashville Predators', sent: 'Jason Dickinson (C)', recv: 'Filip Forsberg (LW)', expect: 'low', reason: 'Dickinson not valuable enough' },
  { id: 47, team: 'blackhawks', sport: 'nhl', partner: 'Dallas Stars', sent: 'Taylor Hall (LW), 2026 2nd Round', recv: 'Jason Robertson (LW)', expect: 'mid', reason: 'Good value match with pick' },
  ...
  { id: 49, team: 'blackhawks', sport: 'nhl', partner: 'New Jersey Devils', sent: 'Lukas Reichel (LW), 2026 1st Round, 2027 2nd Round', recv: 'Jack Hughes (C)', expect: 'low-mid', reason: 'Hughes much more valuable' },
  ...
  { id: 51, team: 'blackhawks', sport: 'nhl', partner: 'Winnipeg Jets', sent: 'Taylor Hall (LW)', recv: 'Mark Scheifele (C)', expect: 'mid', reason: 'Both aging vets, rebuild context' },
  ...
  { id: 53, team: 'blackhawks', sport: 'nhl', partner: 'St. Louis Blues', sent: 'Petr Mrazek (G)', recv: 'Jordan Kyrou (RW)', expect: 'low', reason: 'Goalie much less valuable than young winger' },
  { id: 54, team: 'blackhawks', sport: 'nhl', partner: 'Detroit Red Wings', sent: 'Taylor Hall (LW), Jason Dickinson (C)', recv: 'Lucas Raymond (LW)', expect: 'low-mid', reason: 'Raymond has more upside' },
  { id: 55, team: 'blackhawks', sport: 'nhl', partner: 'Boston Bruins', sent: 'Seth Jones (D)', recv: 'David Pastrnak (RW)', expect: 'low', reason: 'Pastrnak more valuable despite Jones cap hit' },
  { id: 56, team: 'blackhawks', sport: 'nhl', partner: 'Minnesota Wild', sent: 'Alex Vlasic (D), 2026 2nd Round', recv: 'Kirill Kaprizov (LW)', expect: 'low', reason: 'Kaprizov is superstar, this is not enough' },
  ...
  { id: 58, team: 'blackhawks', sport: 'nhl', partner: 'Los Angeles Kings', sent: 'Seth Jones (D), 2027 1st Round', recv: 'Drew Doughty (D), Anze Kopitar (C)', expect: 'mid', reason: 'Cap dumps all around, veteran swap' },
  { id: 59, team: 'blackhawks', sport: 'nhl', partner: 'Calgary Flames', sent: 'Petr Mrazek (G), 2026 3rd Round', recv: 'Nazem Kadri (C)', expect: 'mid', reason: 'Both declining, goalie + pick for center' },
  { id: 60, team: 'blackhawks', sport: 'nhl', partner: 'Ottawa Senators', sent: 'Taylor Hall (LW), 2026 1st Round', recv: 'Tim Stutzle (C)', expect: 'low-mid', reason: 'Stutzle young star, might need more' },
  ...
  { id: 64, team: 'cubs', sport: 'mlb', partner: 'Atlanta Braves', sent: 'Dansby Swanson (SS)', recv: 'Ronald Acuna Jr. (RF)', expect: 'low', reason: 'Acuna much more valuable when healthy' },
  ...
  { id: 66, team: 'cubs', sport: 'mlb', partner: 'Houston Astros', sent: 'Nico Hoerner (2B)', recv: 'Yordan Alvarez (DH)', expect: 'low', reason: 'Alvarez is a superstar bat' },
  { id: 67, team: 'cubs', sport: 'mlb', partner: 'Texas Rangers', sent: 'Cody Bellinger (1B), 2026 2nd Round', recv: 'Corey Seager (SS)', expect: 'low-mid', reason: 'Seager on big deal but elite' },
  { id: 68, team: 'cubs', sport: 'mlb', partner: 'Seattle Mariners', sent: 'Justin Steele (SP), Ian Happ (LF)', recv: 'Julio Rodriguez (CF)', expect: 'mid', reason: 'Good package for young star' },
  { id: 69, team: 'cubs', sport: 'mlb', partner: 'Baltimore Orioles', sent: 'Dansby Swanson (SS), 2026 1st Round', recv: 'Adley Rutschman (C)', expect: 'mid', reason: 'Elite catcher, good package' },
  ...
  { id: 71, team: 'cubs', sport: 'mlb', partner: 'Cleveland Guardians', sent: 'Ian Happ (LF)', recv: 'Jose Ramirez (3B)', expect: 'low', reason: 'Ramirez is elite, massive value gap' },
  ...
  { id: 74, team: 'cubs', sport: 'mlb', partner: 'Milwaukee Brewers', sent: 'Ian Happ (LF), 2026 3rd Round', recv: 'Willy Adames (SS)', expect: 'mid', reason: 'Division trade, fair value' },
  { id: 75, team: 'cubs', sport: 'mlb', partner: 'Arizona Diamondbacks', sent: 'Dansby Swanson (SS)', recv: 'Corbin Carroll (CF)', expect: 'low-mid', reason: 'Carroll young star, Swanson aging' },
  { id: 76, team: 'cubs', sport: 'mlb', partner: 'Pittsburgh Pirates', sent: 'Jameson Taillon (SP)', recv: 'Bryan Reynolds (CF)', expect: 'mid', reason: 'Both mid-tier, reasonable swap' },
  { id: 77, team: 'cubs', sport: 'mlb', partner: 'St. Louis Cardinals', sent: 'Nico Hoerner (2B), 2026 2nd Round', recv: 'Nolan Arenado (3B)', expect: 'mid', reason: 'Arenado aging, Cardinals might sell' },
  { id: 78, team: 'cubs', sport: 'mlb', partner: 'San Francisco Giants', sent: 'Ian Happ (LF)', recv: 'Logan Webb (SP)', expect: 'mid', reason: 'Both solid, ace SP might need more' },
  { id: 79, team: 'cubs', sport: 'mlb', partner: 'Cincinnati Reds', sent: 'Justin Steele (SP), 2027 3rd Round', recv: 'Elly De La Cruz (SS)', expect: 'low', reason: 'EDLC has elite upside, not enough' },
  { id: 80, team: 'cubs', sport: 'mlb', partner: 'Washington Nationals', sent: 'Cody Bellinger (1B)', recv: 'CJ Abrams (SS)', expect: 'low-mid', reason: 'Young talent for veteran, might work' },
  ...
  { id: 84, team: 'whitesox', sport: 'mlb', partner: 'Houston Astros', sent: 'Andrew Vaughn (1B)', recv: 'Jose Altuve (2B)', expect: 'low-mid', reason: 'Altuve aging but still elite, Vaughn less valuable' },
  { id: 85, team: 'whitesox', sport: 'mlb', partner: 'Philadelphia Phillies', sent: 'Garrett Crochet (SP), 2026 2nd Round', recv: 'Bryce Harper (1B)', expect: 'low-mid', reason: 'Harper is superstar, Crochet alone not enough' },
  ...
  { id: 87, team: 'whitesox', sport: 'mlb', partner: 'San Diego Padres', sent: 'Andrew Vaughn (1B), 2026 1st Round', recv: 'Manny Machado (3B)', expect: 'mid', reason: 'Machado aging, salary dump potential' },
  { id: 88, team: 'whitesox', sport: 'mlb', partner: 'Toronto Blue Jays', sent: 'Garrett Crochet (SP)', recv: 'Vladimir Guerrero Jr. (1B)', expect: 'low-mid', reason: 'Vlad worth more than single SP' },
  { id: 89, team: 'whitesox', sport: 'mlb', partner: 'Detroit Tigers', sent: 'Andrew Vaughn (1B)', recv: 'Riley Greene (CF)', expect: 'mid', reason: 'Both young, reasonable swap' },
  ...
  { id: 92, team: 'whitesox', sport: 'mlb', partner: 'Tampa Bay Rays', sent: 'Garrett Crochet (SP)', recv: 'Shane McClanahan (SP), 2026 2nd Round', expect: 'mid-high', reason: 'SP swap with pick, rebuilding works' },
  { id: 93, team: 'whitesox', sport: 'mlb', partner: 'Miami Marlins', sent: 'Andrew Vaughn (1B)', recv: 'Jazz Chisholm Jr. (2B)', expect: 'low-mid', reason: 'Jazz more valuable, both rebuilding' },
  ...
  { id: 98, team: 'whitesox', sport: 'mlb', partner: 'Los Angeles Angels', sent: 'Garrett Crochet (SP), Andrew Vaughn (1B)', recv: 'Mike Trout (CF)', expect: 'low-mid', reason: 'Trout aging, big salary, but still Trout' },
  { id: 99, team: 'whitesox', sport: 'mlb', partner: 'New York Mets', sent: 'Luis Robert Jr. (CF), 2026 1st Round', recv: 'Pete Alonso (1B)', expect: 'low', reason: 'Robert + 1st is overpay for Alonso' },
  { id: 100, team: 'whitesox', sport: 'mlb', partner: 'San Francisco Giants', sent: 'Garrett Crochet (SP)', recv: 'Logan Webb (SP)', expect: 'mid-high', reason: 'Elite SP for elite SP, both controlled' },
]
...
function gradeMatchesExpectation(grade, expect) {
  if (expect === 'zero') return grade <= 15
  if (expect === 'low') return grade >= 10 && grade <= 50
  if (expect === 'low-mid') return grade >= 25 && grade <= 60
  if (expect === 'mid') return grade >= 35 && grade <= 75
  if (expect === 'mid-high') return grade >= 55 && grade <= 90
  if (expect === 'high') return grade >= 70
  return true
}
